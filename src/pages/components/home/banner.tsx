            ...
            <div className="border border-5 border-primary rounded-3 w-100 px-2 m-5 bg-dark">
                <div className="row">
                    ...
                    <div className="row m-0 flex-md-row flex-column align-items-center justify-content-md-evenly py-5 flex-column-reverse flex-md-row bg-opacity-50 rounded-bottom">
                        <div className="col-md-6 text-md-start text-center d-flex flex-column justify-content-center">
                            <p className="fs-4 pt-3 pt-md-0 lh-lg font-monospace"><span className="fs-1">Hi!</span> I am <span className="fs-1">Whistner</span> a</p>
                            <p className="fs-1 font-monospace">Jr. Full Stack Web Developer</p>
                            <p className='font-monospace fs-4'>Based in the Philippines, the Pearl of the East!</p>
                            <Social />
                        </div>
